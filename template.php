...
function whywebs_2016_preprocess_page(&$variables) {
  drupal_add_js(drupal_get_path('theme', 'whywebs_2016') .'/build/scripts/vendor/modernizr-2.8.3.min.js', array("group" => JS_LIBRARY, "weight" => 115));
}
...
function whywebs_2016_css_alter(&$css) {
  $count = 0;
